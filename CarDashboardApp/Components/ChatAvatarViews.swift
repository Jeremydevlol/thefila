...
// MARK: - Avatar lista / toolbar (foto + insignia)
...
struct ChatThreadAvatarView: View {
    ...
    var body: some View {
        ZStack(alignment: .bottomTrailing) {
            Group {
                if let url = thread.avatarImageURL {
                    ChatAsyncAvatarThumbnail(url: url)
            ...
            if thread.avatarImageURL != nil, let platform = thread.socialSource {
...
// MARK: - Miniatura remota

private struct ChatAsyncAvatarThumbnail: View {
    let url: URL
